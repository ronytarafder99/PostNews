...
<div class="home_page_part_one_bg">
    <div class="custom_container home_page_part_one">
        <div class="home_page_part_one_left cs_border-right">
            <h2 class="home_sidebar_cat_title">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_2']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_2']); ?></a>
                <a href="<?php echo get_category_link($redux_demo['home_cat_2']); ?>"
                    class="read-more d-flex justify-content-end align-items-center">
                    <p><?php echo $redux_demo['read_more']; ?></p>
                    <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                </a>
        ...
        <div class="home_page_part_one_right">
            <h2 class="home_sidebar_cat_title">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_3']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_3']); ?></a>
    ...
    <div class="custom_container home_page_part_one">
        <div class="home_page_part_one_left cs_border-right">
            <h2 class="home_sidebar_cat_title d-flex">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_4']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_4']); ?></a>
                <a href="<?php echo get_category_link($redux_demo['home_cat_4']); ?>"
                    class="read-more d-flex justify-content-end align-items-center">
                    <p><?php echo $redux_demo['read_more']; ?></p>
                    <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                </a>
                    ...
                    <div class="form_col">
                        <select class="form-control" name="bd_thana" id="upozilla">
                            ...
                            <?php foreach ($upozilas as $upozila) :  // Level One 
                                    ?>
                            <option id="upo" value="<?php echo get_term_link($upozila->term_id); ?>"
                                style="display:none" class="thana-<?php echo $district->term_id; ?>"
...
<div class="home_page_part_one_bg opinion-contents">
    <div class="custom_container home_page_part_one">
        <div class="home_page_part_one_left">
            <h2 class="home_sidebar_cat_title d-flex">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_5']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_5']); ?></a>
                <a href="<?php echo get_category_link($redux_demo['home_cat_5']); ?>"
                    class="read-more d-flex justify-content-end align-items-center">
                    <p><?php echo $redux_demo['read_more']; ?></p>
                    <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                </a>
        ...
        <div class="home_page_part_one_right">
            <h2 class="home_sidebar_cat_title d-flex">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_6']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_6']); ?></a>
                <a href="<?php echo get_category_link($redux_demo['home_cat_6']); ?>"
                    class="read-more d-flex justify-content-end align-items-center">
                    <p><?php echo $redux_demo['read_more']; ?></p>
                    <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                </a>
...
<div class="home_page_part_one_bg">
    <div class="custom_container">
        <h2 class="home_sidebar_cat_title d-flex">
            <a
                href="<?php echo get_category_link($redux_demo['home_cat_7']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_7']); ?></a>
            <a href="<?php echo get_category_link($redux_demo['home_cat_7']); ?>"
                class="read-more d-flex justify-content-end align-items-center">
                <p><?php echo $redux_demo['read_more']; ?></p>
                <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
            </a>
...
<div class="home_page_part_one_bg">
    <div class="custom_container home_page_part_one justify-content-between">
        <div class="home_page_part_left cs_border-right">
            <h2 class="home_sidebar_cat_title d-flex">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_8']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_8']); ?></a>
                <a href="<?php echo get_category_link($redux_demo['home_cat_8']); ?>"
                    class="read-more d-flex justify-content-end align-items-center">
                    <p><?php echo $redux_demo['read_more']; ?></p>
                    <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                </a>
        ...
        <div class="home_page_part_right">
            <h2 class="home_sidebar_cat_title d-flex">
                <a
                    href="<?php echo get_category_link($redux_demo['home_cat_9']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_9']); ?></a>
                <a href="<?php echo get_category_link($redux_demo['home_cat_9']); ?>"
                    class=" read-more d-flex justify-content-end align-items-center">
                    <p><?php echo $redux_demo['read_more']; ?></p>
                    <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                </a>
    ...
    <div class="custom_container">
        <div class="home_page_part_one">
            <ul class="leatest_in_a_cat_postlopp" style="flex: 1;">
                <h2 class="home_sidebar_cat_title d-flex">
                    <a
                        href="<?php echo get_category_link($redux_demo['home_cat_10']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_10']); ?></a>
                    <a href="<?php echo get_category_link($redux_demo['home_cat_10']); ?>"
                        class="read-more d-flex justify-content-end align-items-center">
                        <p><?php echo $redux_demo['read_more']; ?></p>
                        <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                    </a>
            ...
            <ul class="leatest_in_a_cat_postlopp" style="flex: 1;">
                <h2 class="home_sidebar_cat_title d-flex">
                    <a
                        href="<?php echo get_category_link($redux_demo['home_cat_12']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_12']); ?></a>
                    <a href="<?php echo get_category_link($redux_demo['home_cat_12']); ?>"
                        class="read-more d-flex justify-content-end align-items-center">
                        <p><?php echo $redux_demo['read_more']; ?></p>
                        <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                    </a>
...
<div class="home_page_part_one_bg">
    <div class="custom_container">
        <h2 class="home_sidebar_cat_title d-flex">
            <a
                href="<?php echo get_category_link($redux_demo['home_cat_13']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_13']); ?></a>
            <a href="<?php echo get_category_link($redux_demo['home_cat_13']); ?>"
                class="read-more d-flex justify-content-end align-items-center">
                <p><?php echo $redux_demo['read_more']; ?></p>
                <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
            </a>
    ...
    <div class="custom_container">
        <div class="three_coloumn">
            <div class="column_one">
                <h2 class="home_sidebar_cat_title d-flex">
                    <a
                        href="<?php echo get_category_link($redux_demo['home_cat_14']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_14']); ?></a>
                    <a href="<?php echo get_category_link($redux_demo['home_cat_14']); ?>"
                        class="read-more d-flex justify-content-end align-items-center">
                        <p><?php echo $redux_demo['read_more']; ?></p>
                        <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                    </a>
            ...
            <div class="column_one">
                <h2 class="home_sidebar_cat_title d-flex">
                    <a
                        href="<?php echo get_category_link($redux_demo['home_cat_15']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_15']); ?></a>
                    <a href="<?php echo get_category_link($redux_demo['home_cat_15']); ?>"
                        class="read-more d-flex justify-content-end align-items-center">
                        <p><?php echo $redux_demo['read_more']; ?></p>
                        <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                    </a>
            ...
            <div class="column_one">
                <h2 class="home_sidebar_cat_title d-flex">
                    <a
                        href="<?php echo get_category_link($redux_demo['home_cat_17']); ?>"><?php echo get_the_category_by_id($redux_demo['home_cat_17']); ?></a>
                    <a href="<?php echo get_category_link($redux_demo['home_cat_17']); ?>"
                        class="read-more d-flex justify-content-end align-items-center">
                        <p><?php echo $redux_demo['read_more']; ?></p>
                        <p><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>
                    </a>
...
<!-- PhotoGallery -->
<?php if ($redux_demo['show_photos'] == '1') { ?>
<div class="home_page_part_one_bg">
    <div class="custom_container">
        <h2 class="home_sidebar_cat_title d-flex">
            <a
                href="<?php echo get_post_type_archive_link('photogallery'); ?>"><?php echo $redux_demo['photo_name']; ?></a>
...
<!-- VodeoGallery -->
<?php if ($redux_demo['show_videos'] == '1') { ?>
<div class="home_page_part_one_bg">
    <div class="custom_container">
        <h2 class="home_sidebar_cat_title d-flex">
            <a
                href="<?php echo get_post_type_archive_link('videogallery'); ?>"><?php echo $redux_demo['video_name']; ?></a>
                ...
                <div class="video-wrapper">
                    <a href="<?php the_permalink(); ?>">
                        <div class="vide-thumbnail">
                            ...
                            <img class="img-fluid" src="<?php bloginfo('template_directory'); ?>/img/default-img_final.gif"
                                alt="<?php the_title(); ?>" />
                            <?php } ?>
